...
// BenchmarkDecodeEncodeMediaSegmentSliceWriter - see profiling.txt for values
func BenchmarkDecodeEncodeMediaSegmentSliceWriter(b *testing.B) {
	inFile := "testdata/1.m4s"
	inRaw, _ := ioutil.ReadFile(inFile)
